...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = '/MVC-2/API/aplicacion/guardar';
...
const Buscar = async () => {
    ...
    const url = '/MVC-2/API/aplicacion/buscar';
...
const Modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario)
        const url = '/MVC-2/API/aplicacion/modificar';
...
const Eliminar = async (aplicacion) => {
    ...
    if (confirmacion.isConfirmed) {
        ...
        try {
            ...
            const url = '/MVC-2/API/aplicacion/eliminar';
            const config = {
                method: 'POST',
                body
            }
