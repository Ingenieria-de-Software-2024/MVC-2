...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = '/MVC-2/API/productos/guardar';
...
const Buscar = async () => {
    ...
    const url = '/MVC-2/API/productos/buscar';
...
const Modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario)
        const url = '/MVC-2/API/productos/modificar';
...
const Eliminar = async (productos) => {
    ...
    if (confirmacion.isConfirmed) {
        ...
        try {
            ...
            const url = '/MVC-2/API/productos/eliminar';
            const config = {
                method: 'POST',
                body
            }
