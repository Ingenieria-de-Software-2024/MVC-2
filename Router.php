...
class Router
{
    ...
    public function render($view, $datos = [], $layout = 'layouts/layout') //agregamos public function render($view, $datos = [], $layout = 'layouts/layout')
    {
        ...
        include_once __DIR__ . "/views/$layout.php"; //Agregamos $ y Comillas dobles
    }
